...
STAGE='1000I_GENERATION_RESULT_TO_WORK_OBJECT_PATCH_FIXTURE'
FINAL='XIAOJIAO_GENERATION_RESULT_TO_WORK_OBJECT_PATCH_FIXTURE_PASS'
SLUG='xiaojiao_generation_result_to_work_object_patch_fixture_1000I'
MARKER='ALL_1000I_GENERATION_RESULT_TO_WORK_OBJECT_PATCH_FIXTURE_CHECKS_OK'
SAMPLE='generation_result_to_work_object_patch_fixture_1000I.json'
