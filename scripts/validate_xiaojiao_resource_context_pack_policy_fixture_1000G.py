...
STAGE='1000G_RESOURCE_CONTEXT_PACK_POLICY_FIXTURE'
FINAL='XIAOJIAO_RESOURCE_CONTEXT_PACK_POLICY_FIXTURE_PASS'
SLUG='xiaojiao_resource_context_pack_policy_fixture_1000G'
MARKER='ALL_1000G_RESOURCE_CONTEXT_PACK_POLICY_FIXTURE_CHECKS_OK'
SAMPLE='resource_context_pack_policy_fixture_1000G.json'
