...
STAGE='1000F_MODEL_CANDIDATE_AND_RESOURCE_CONTEXT_INTEGRATION_CONTRACT'
FINAL='XIAOJIAO_MODEL_CANDIDATE_RESOURCE_CONTEXT_INTEGRATION_CONTRACT_PASS'
SLUG='xiaojiao_model_candidate_resource_context_integration_contract_1000F'
MARKER='ALL_1000F_MODEL_CANDIDATE_RESOURCE_CONTEXT_INTEGRATION_CONTRACT_CHECKS_OK'
SAMPLE='resource_context_contract_sample_1000F.json'
